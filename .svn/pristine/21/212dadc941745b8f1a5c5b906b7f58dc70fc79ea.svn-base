...
<div class="panel panel-default">
        ...
        <form method="post" action="/index.php?m=cps_manage&c=cm_unionlist&a=batchPushCDN&product_id=<?php echo $_GET['product_id']; ?>" enctype="multipart/form-data" class="form-horizontal text-left" id="linemeta_line" role="form">
