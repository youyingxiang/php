...
// following "signature" as the first three bytes: ï»¿  ... Encoding issues are beyond
...
//      mytitle		Démonstration de Localisation
//      mylabel		Choisir un code de langue
//
//      #divtest	Il s'agit d'un DIV automatiquement mis à jour.
// ---------------------------------------------------------------------------
//
            ...
            for (var i = 0; i < rawText.length; i++) {
                ...
                if (sep >= 0) {
                    ...
                    if (datkey.substring(0, 2) != "//"                      // ignore comment lines
                       && datkey.substring(0, 3) != "ï»¿") {                // ignore UTF-8 signature line
                        if (datkey.charAt(0) == "#")
