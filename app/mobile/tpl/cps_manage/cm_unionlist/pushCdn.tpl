...
<div class="panel panel-default">
        ...
        <br />
        <form role="form" id="linemeta_line" class="form-horizontal text-left" method="post" action="index.php?m=cps_manage&c=cm_unionlist&a=pushCdn&id=<?php echo $_GET['id']; ?>">            
