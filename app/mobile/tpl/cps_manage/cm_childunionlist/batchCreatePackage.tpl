...
<div class="panel panel-default">
       ...
       <!-- 未实现状态筛选
        ...
        <form method="post" action="/index.php?m=cps_manage&c=cm_childunionlist&a=batchCreatePackage&parent_id=<?php echo $_GET['parent_id']; ?>" enctype="multipart/form-data" class="form-horizontal text-left" id="linemeta_line" role="form">
        ...
        <table class="table" style="width:98%">
          ...
          <tr class="channels" onclick="trSelect(this)">
            <td align="center"><input type="checkbox" name="child_union_id[]" value="<?php echo $v['id']; ?>" onclick="trSelect($(this).parents('.channels'))"></td>
        ...
        <br>
        <br>
        <div class="form-group" style="height:100px"><div class="col-sm-4 col-sm-offset-4"><button class="btn btn-primary" type="submit" name="submitSelectCode">&nbsp;&nbsp;&nbsp;提交&nbsp;&nbsp;&nbsp;</button></div></div>
        </form>
    ...
    $(function(){
        $("#selectbox").bind("click",function(){
            if($("#selectbox").prop("checked")){
                $("input[name='child_union_id[]']").prop("checked",true);  
            }else{
                $("input[name='child_union_id[]']").prop("checked",false);  
            }
        })
    })
