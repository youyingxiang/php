...
<div class="panel panel-default">
        ...
        <form method="post" action="/index.php?m=cps_manage&c=cm_childunionlist&a=batchPushCDN&parent_id=<?php echo $_GET['parent_id']; ?>" enctype="multipart/form-data" class="form-horizontal text-left" id="linemeta_line" role="form">
