...
$.extend( $.fn.dataTableExt.oPagination, {
    "bootstrap": {
        "fnInit": function( oSettings, nPaging, fnDraw ) {
            ...
            $(nPaging).addClass('pagination paging_simple_numbers').css("float","right").append(
                '<ul class="pagination">'+
                '<li class="first disabled"><a href="#">'+oLang.sFirst+'</a></li>'+
                '<li class="prev disabled"><a href="#">&larr; '+oLang.sPrevious+'</a></li>'+
                '<li class="next disabled"><a href="#">'+oLang.sNext+' &rarr; </a></li>'+
                '<li class="last disabled"><a href="#">'+oLang.sLast+'</a></li>'+
                '<input type="text" style="width: 40px;height: 30px;margin-left:5px;outline:none; padding: 0px 0px 0px 5px;border: 1px solid #ccc;border-radius: 3px;" id="redirect" class="redirect">'+
                '</ul>'
                );
